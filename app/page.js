        ...
        <div className="container">
          <div className="row text-md-start text-sm-center text-center gap-md-0 gap-sm-4 gap-5">
            <div data-aos="fade-up" className="col-md-6 d-flex align-items-md-start align-items-ms-center align-items-center justify-content-center flex-column">
              ...
              {/* <a className="btn-hover1" href="#">View Resume</a> */}
            </div>
            ...
            <div className="col-lg-6 col-md-6 mt-md-0 mt-sm-5 mt-5" data-aos="fade-down">
              ...
              <div className="pric-list">
                ...
                <div className="d-flex">
                  <div className="d-flex justify-content-between gap-1">
                    <p className="p-f-s">In this position at Arymaid, I created web applications that were easily scalable with Laravel framework and clean, reusable,
              ...
              <div className="pric-list second">
                ...
                <div className="d-flex justify-content-between">
                  <div className="d-flex justify-content-between">
                    <p className="p-f-s">While implementing the Company System Management Dashboard at
              ...
              <div className="pric-list">
                ...
                <div className="d-flex">
                  ...
                  <div className="d-flex justify-content-between gap-1">
                    <p className="p-f-s">In this role as Freelance Software Developer,
              ...
              <div className="pric-list second">
                ...
                <div className="d-flex justify-content-between">
                  <div className="d-flex justify-content-between">
                    <p className="p-f-s">I was a Freelance WordPress Developer, and my main tasks were the construction of WordPress sites, from themes and plugins.
              ...
              <div className="pric-list ">
                ...
                <div className="d-flex justify-content-between">
                  <div className="d-flex justify-content-between">
                    <p className="p-f-s">I design and develop e-books that are informative for specific
              ...
              <div className="prof-slide-wrapper">
                <div className="prof-slide position-relative">
                  <div>
                    ...
                    <p className="text-center p-f-s">Collaboration with MenhCoding has changed the approach to our projects. The skills in Python as well as the use of web applications such as Django and React have improved the speed and afforded user-friendliness of the applications. They particularly have a good experience in aspects like problem solving and in offering timeless solutions.</p>
                    ...
                    <p className="text-center pt-2 pb-5 p-f-s">Project Lead at CodeWave</p>
                  </div>
                </div>
                <div className="prof-slide position-relative">
                  <div>
                    ...
                    <p className="text-center p-f-s">Overall, MenhCoding has been a good collaborator in our machine learning projects. Their knowledge in TensorFlow, Keras, and data science proved invaluable to our project. They support themselves and are always willing to lend a hand to other members of the team.</p>
                    <div className="prof-star pt-2 pb-2 text-center">
                      <span className="stars text-lg-start">
                        <i className="fa-solid fa-star"></i>
                        <i className="fa-solid fa-star"></i>
                    ...
                    <p className="text-center pt-2 pb-5 p-f-s">Lead Developer at DevTech</p>
                  </div>
                </div>
                <div className="prof-slide position-relative">
                  <div>
                    ...
                    <p className="text-center p-f-s">MenhCoding has been instrumental in enhancing our cloud infrastructure through his skills in AWS and Docker. Their work has helped greatly in making our deployment process more efficient and reliable. However, the high-quality work from both of them including attentiveness and dedication cannot be faulted.</p>
                    <div className="prof-star pt-2 pb-2 text-center">
                      <span className="stars text-lg-start">
                        <i className="fa-solid fa-star"></i>
                        <i className="fa-solid fa-star"></i>
                    ...
                    <p className="text-center pt-2 pb-5 p-f-s">CTO at NetCloud</p>
                  </div>
                </div>
              </div>
                ...
                <div className="card news-card-back">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text p-f-s">
                      ...
                      for customers from browsing to purchase.</p>                  </div>
                  <hr className="dotted-line" />
                  <div className="card-viewer">
                    <span className="githubLink">Github Link</span>
                    <span>#Next.js</span>
